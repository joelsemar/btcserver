...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackTable.game_state'
        db.add_column('blackjack_blackjacktable', 'game_state', self.gf('django.db.models.fields.CharField')(default='bidding', max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackTable.game_state'
        db.delete_column('blackjack_blackjacktable', 'game_state')
