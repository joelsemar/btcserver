...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.doubled'
        db.add_column('blackjack_blackjackhand', 'doubled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackHand.doubled'
        db.delete_column('blackjack_blackjackhand', 'doubled')
