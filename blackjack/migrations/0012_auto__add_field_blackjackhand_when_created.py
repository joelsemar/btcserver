...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.when_created'
        db.add_column('blackjack_blackjackhand', 'when_created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2011, 5, 23, 6, 9, 13, 859012)), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackHand.when_created'
        db.delete_column('blackjack_blackjackhand', 'when_created')
    ...
    models = {
        ...
        'blackjack.blackjackhand': {
            ...
            'available_actions': ('django.db.models.fields.CharField', [], {'default': '\'["hit", "stand", "double", "surrender", "split"]\'', 'max_length': '256'}),
            'bet': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '12', 'decimal_places': '8'}),
            'cards': ('django.db.models.fields.TextField', [], {'default': "'[]'", 'max_length': '512'}),
            'dealers_hand': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'doubled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'player': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['backend.Player']", 'null': 'True'}),
            'resolved': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'round': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['blackjack.BlackJackRound']"}),
            'split': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'split_from'", 'null': 'True', 'to': "orm['blackjack.BlackJackHand']"}),
            'stood': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'when_created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 5, 23, 6, 9, 13, 859012)'})
        },
        'blackjack.blackjackround': {
            'Meta': {'ordering': "('-started',)", 'object_name': 'BlackJackRound'},
            'closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'started': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.utcnow'}),
        ...
        'blackjack.blackjacktable': {
            ...
            'game_state': ('django.db.models.fields.CharField', [], {'default': "'bidding'", 'max_length': '32'}),
