...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'BlackJackHand.cards'
        db.alter_column('blackjack_blackjackhand', 'cards', self.gf('django.db.models.fields.CharField')(max_length=128))
    ...
    models = {
        ...
        'blackjack.blackjackhand': {
            ...
            'cards': ('django.db.models.fields.CharField', [], {'default': "'[]'", 'max_length': '512'}),
