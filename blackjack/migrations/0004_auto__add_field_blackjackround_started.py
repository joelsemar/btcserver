...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackRound.started'
        db.add_column('blackjack_blackjackround', 'started', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.utcnow), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackRound.started'
        db.delete_column('blackjack_blackjackround', 'started')
