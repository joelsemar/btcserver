...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.available_actions'
        db.add_column('blackjack_blackjackhand', 'available_actions', self.gf('django.db.models.fields.CharField')(default='["hit", "stand", "double", "surrender"]', max_length=256), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackHand.available_actions'
        db.delete_column('blackjack_blackjackhand', 'available_actions')
    ...
    models = {
        ...
        'blackjack.blackjackhand': {
            ...
            'available_actions': ('django.db.models.fields.CharField', [], {'default': '\'["hit", "stand", "double", "surrender"]\'', 'max_length': '256'}),
