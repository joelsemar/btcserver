...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blackjack_blackjacktabletype', 'high_bet', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=8))

        # Changing field 'BlackJackTableType.low_bet'
        db.alter_column('blackjack_blackjacktabletype', 'low_bet', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=8))

        # Changing field 'BlackJackBet.amount'
        db.alter_column('blackjack_blackjackbet', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=8))


    def backwards(self, orm):
        
        # Changing field 'BlackJackTableType.high_bet'
        db.alter_column('blackjack_blackjacktabletype', 'high_bet', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'BlackJackTableType.low_bet'
        db.alter_column('blackjack_blackjacktabletype', 'low_bet', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'BlackJackBet.amount'
        db.alter_column('blackjack_blackjackbet', 'amount', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
