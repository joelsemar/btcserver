...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackTableType.name'
        db.add_column('blackjack_blackjacktabletype', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackTableType.name'
        db.delete_column('blackjack_blackjacktabletype', 'name')
