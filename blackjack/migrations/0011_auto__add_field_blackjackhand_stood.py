...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.stood'
        db.add_column('blackjack_blackjackhand', 'stood', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackHand.stood'
        db.delete_column('blackjack_blackjackhand', 'stood')
