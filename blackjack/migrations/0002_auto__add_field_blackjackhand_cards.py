...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.cards'
        db.add_column('blackjack_blackjackhand', 'cards', self.gf('django.db.models.fields.CharField')(default='', max_length=128), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BlackJackHand.cards'
        db.delete_column('blackjack_blackjackhand', 'cards')
    ...
    models = {
        ...
        'blackjack.blackjackhand': {
            ...
            'cards': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
