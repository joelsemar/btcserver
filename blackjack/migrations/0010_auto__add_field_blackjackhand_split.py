...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BlackJackHand.split'
        db.add_column('blackjack_blackjackhand', 'split', self.gf('django.db.models.fields.related.ForeignKey')(related_name='split_from', null=True, to=orm['blackjack.BlackJackHand']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BlackJackHand.split'
        db.delete_column('blackjack_blackjackhand', 'split_id')
