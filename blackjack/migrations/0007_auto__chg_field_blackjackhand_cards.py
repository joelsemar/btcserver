...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BlackJackHand.cards'
        db.alter_column('blackjack_blackjackhand', 'cards', self.gf('django.db.models.fields.TextField')(max_length=512))


    def backwards(self, orm):
        
        # Changing field 'BlackJackHand.cards'
        db.alter_column('blackjack_blackjackhand', 'cards', self.gf('django.db.models.fields.CharField')(max_length=512))
