...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Player.handle'
        db.add_column('backend_player', 'handle', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Player.handle'
        db.delete_column('backend_player', 'handle')
