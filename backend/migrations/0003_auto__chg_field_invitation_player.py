...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Invitation.player'
        db.alter_column('backend_invitation', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Player'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Invitation.player'
        db.alter_column('backend_invitation', 'player_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Player']))
    ...
    models = {
        ...
        'backend.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'mnEpLDzgVYwS6tEVeKO-BnTbT1bCeDsb'", 'max_length': '32', 'blank': 'True'}),
