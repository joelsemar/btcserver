...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('backend_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(default='pTAxFM5vkimCrF9dAY-utkDIZA6TfdN3', max_length=32, blank=True)),
            ('player', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['backend.Player'])),
        ))
        db.send_create_signal('backend', ['Invitation'])


    def backwards(self, orm):
        
        # Deleting model 'Invitation'
        db.delete_table('backend_invitation')
    ...
    models = {
        ...
        'backend.invitation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'default': "'jnJNALsW_1Z0bufeuvc8lMXguhVG1cG8'", 'max_length': '32', 'blank': 'True'}),
