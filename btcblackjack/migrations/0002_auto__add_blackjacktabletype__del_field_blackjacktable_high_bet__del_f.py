...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('btcblackjack_blackjacktabletype', (
        ...
        db.send_create_signal('btcblackjack', ['BlackJackTableType'])

        # Deleting field 'BlackJackTable.high_bet'
        db.delete_column('btcblackjack_blackjacktable', 'high_bet')
    ...
    def backwards(self, orm):
        ...
        db.delete_table('btcblackjack_blackjacktabletype')
        ...
        db.delete_column('btcblackjack_blackjacktable', 'type_id')
